...
breaks1 = c(2, 6, 11, 21, 34, 382)
breaks2 = c(3, 14, 24, 35, 44, 159) 
...
t=tmap_arrange(tm1, tm2, legend, tm3, ncol=2)
t
...
pal1 <-colorBin(palette = "YlOrRd", domain=Joined$`Airbnb count`, bins=breaks2)

pal2 <- Joined %>%
  colorBin(palette = "YlOrRd", domain=.$`Hotel count`, bins=breaks1)
